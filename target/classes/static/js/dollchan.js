...
const defaultCfg = {
	...
	postBtnsCSS  : 0,    // post buttons style [0=simple, 1=gradient grey, 2=custom]
...
const Lng = {
	...
	cfg: {
		...
		updCount: [
			...
			'Зворотній відлік оновлення нитки'],
		favIcoBlink: [
		...
		showRepBtn: {
			...
			txt: [
				...
				'Кнопки "Відповісти на допис/нитку"']
		},
		postBtnsCSS: {
			sel: [
		...
		imgInfoLink: [
			...
			'Імʼя файла під розгорнутим зображенням'],
		resizeDPI: [
		...
		webmVolume: [
			...
			'Гучність WebM за промовчанням [0-100%]'],
		minWebmWidth: [
		...
		preLoadImgs: {
			...
			txt: [
				...
				'Preload images*',
				'Завантажувати зображення наперед*']
		},
		findImgFile: [
		...
		linksNavig: [
			...
			'Навігація дописів за >>посиланнями* '],
		linksOver: [
			'Появление ',
			'Appearance ',
			'Поява '],
		...
		addOPLink: [
			...
			'>>посилання при відповіді на OP у списку ниток'],
		addImgs: [
		...
		embedYTube: {
			sel: [
				...
				['Нічого', 'Превʼю+плеєр', 'Плеєр на клік']],
			txt: [
				'к YouTube ссылкам* ',
				'for YouTube links* ',
				'до YouTube-посилань* ']
		...
		scrAfterRep: [
			...
			'Перейти до кінця нитки після надсилання'],
		fileInputs: {
			sel: [
				['Откл.', 'Упрощ.', 'Превью'],
		...
		favOnReply: [
			...
			'Додавати нитку в "Вибране" після відповіді'],
		warnSubjTrip: [
	...
	panelBtn: {
		...
		'upd-on': [
			...
			'Вимкнути автооновлення нитки'],
		'upd-off': [
			'Включить автообновление треда',
			'Enable thread updater',
			'Увімкнути автооновлення нитки'],
		'audio-off': [
		...
		pcountNotHid: [
			...
			'Дописів у нитці (крім прихованих)'],
		imglen: [
			'Картинок в треде',
			'Images in thread',
			'Зображень у нитці'],
	...
	togglePost: [
		...
		'Hide/Unhide post',
		'Приховати/показати допис'],
	toggleThr: [
		'Скрыть/Раскрыть тред',
		'Hide/Unhide thread',
		'Приховати/показати нитку'],
	replyToPost: [
		'Ответить на пост',
		'Reply to post',
		'Відповісти на допис'],
	...
	selHiderMenu: { // "Hide" post button
		...
		img: [
			...
			'Hide by image size',
			'Ховати за розміром зображення'],
		imgn: [
			'Скрывать по имени картинки',
			'Hide by image name',
			'Ховати за іменем зображення'],
		ihash: [
		...
		text: [
			'Скрыть схожий текст',
			'Hide similar text',
			'Приховати схожий текст'],
		refs: [
			'Скрыть с ответами',
			'Hide with replies',
			'Приховати з відповідями'],
		refsonly: [
			'Скрывать ответы',
			'Hide replies',
			'Ховати відповіді']
	...
	hotKeyEdit: [[
		...
		'%l%i21 – нитка (на дошці)/допис (в нитці) нижче%/l',
	...
	seSyntaxErr: [
		...
		'синтаксична помилка в аргументі спелу: %s'],
	seUnknown: [
		'неизвестный спелл: %s',
		'unknown spell: %s',
		'невідомий спел: %s'],
	...
	fileImpExp: [
		...
		'Імпорт/експорт налаштувань до файла'],
	fileToData: [
	...
	descrGlobal: [
		...
		'Глобальні налаштування застосовуються за промовчанням<br>під час першого відвідування інших доменів'],
	resetCfg: [
		'Сбросить в настройки по умолчанию',
		'Reset config to defaults',
		'Скинути до налаштувань за промовчанням'],
	resetData: [
		'Очистить выбранные данные',
		'Reset selected data',
		'Очистити вибрані дані'],
	allDomains: [
		'для всех доменов',
		'for all domains',
		'для всіх доменів'],
	...
	infoPage: [
		...
		'Перевірити актуальність ниток (до 10-ї сторінки)'],
	clrDeleted: [
		'Очистить недоступные (404) треды',
		'Clear inaccessible (404) threads',
		'Очистити недоступні (404) нитки'],
	oldPosts: [
		'Постов при последнем посещении',
		'Posts at the last visit',
		'Дописів під час останнього відвідування'],
	newPosts: [
	...
	pasteImage: [
		...
		'Ctrl+V - вставити зображення з буферу'],
	dropFileHere: [
	...
	openOriginal: [
		...
		'Відкрити оригінал у новій вкладці'],
	...
	noHidThr: [
		'Нет скрытых тредов…',
		'No hidden threads…',
		'Немає прихованих ниток…'],
	noFavThr: [
		'Нет избранных тредов…',
		'Favorites is empty…',
		'Немає вибраних ниток…'],
	noVideoLinks: [
		'Нет ссылок на видео…',
		'No video links…',
	...
	donateMsg: [
		...
		'<b>Дякуємо за використання Dollchan Extension!</b><br>Ви можете підтримати проєкт пожертвою'],
	firefoxAddon: [
...
function getImageBoard(checkDomains, checkEngines) {
	...
	ibDomains['localhost:9092'] = Kropyvach;
